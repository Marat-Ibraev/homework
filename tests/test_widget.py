...
def test_mask_account_card_fixture(account_card: str) -> None:
    assert mask_account_card("Счет 12345678901234567890") == account_card


@pytest.mark.parametrize(
    "date_correct, expected",
    [
...
def test_get_date_fixture(bad_date: str) -> None:
    assert get_date("2021/11/10") == bad_date
