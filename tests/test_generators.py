...
def test_filter_by_currency(filter_by_curr: List[dict]) -> None:
    transactions = (
        [
            {
                "id": 939719570,
...
def test_transaction_description(description) -> None:
    test_description = (
        [
            {
                "id": 939719570,
    ...
    assert transaction_descriptions(test_description)
